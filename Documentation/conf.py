# -*- coding: utf-8 -*-
#
# Indieweb documentation build configuration file, created by
# sphinx-quickstart on Sun Jul 27 19:59:53 2014.
#
...
project = u'Indieweb'
copyright = u'2014, Joschi Kuphal'
...
latex_documents = [
  ('Index', 'Indieweb.tex', u'Indieweb Documentation',
...
man_pages = [
    ('Index', 'indieweb', u'Indieweb Documentation',
     [u'Joschi Kuphal'], 1)
]
...
texinfo_documents = [
  ('Index', 'Indieweb', u'Indieweb Documentation',
   u'Joschi Kuphal', 'Indieweb', 'One line description of project.',
   'Miscellaneous'),
]
...
if 1 and "TYPO3 specific":
    ...
    t3DocTeam['relpath_to_master_doc'] = '../../TYPO3-ext-indieweb-sphinxdoc'             # check this!
