# -*- coding: utf-8 -*-
#
# IndieWeb Publishing Tools documentation build configuration file, created by
# TYPO3 extension sphinx on Fri, 01 Aug 2014 09:58:03 +0200.
#
...
project = u'IndieWeb Publishing Tools'
copyright = u'2014, '
...
htmlhelp_basename = 'IndieWebPublishingToolsdoc'
...
latex_documents = [
    ('Index', 'IndieWebPublishingTools.tex', u'IndieWeb Publishing Tools',
     u'', 'manual'),
]
...
pdf_documents = [
    ('Index', 'IndieWebPublishingTools', u'IndieWeb Publishing Tools',
     u''),
]
...
texinfo_documents = [
    ('Index', 'IndieWebPublishingTools', u'IndieWeb Publishing Tools',
     u'', 'IndieWeb Publishing Tools', 'One line description of project.',
     'Miscellaneous'),
]
